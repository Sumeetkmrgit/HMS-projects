...
Doctorname <input type ="text" name="Doctorname"  value = "<?php echo $_GET['a']; ?>"/></br>
...
if($_GET['submit'])
{
	...
	$dept=$_GET['Dept'];
	$query="UPDATE doctordetail SET Doctorname='$name',Password='$password' ,Email='$email' ,Age='$age' ,Gender='$gender' ,Address='$address' ,Dept='$dept' WHERE id='$id'";
	$data=mysqli_query($conn,$query);
	if($data){
		echo" record is updated!!!!!!!   <a href='didplaydoctordetail.php'>check updated list here</a>";
	}
	else{
